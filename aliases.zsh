...
alias ws="sudo mount -t cifs -o rw,uid=0,gid=0,dir_mode=0777,file_mode=0777,username="guest",password="" //192.168.3.27/报告备份 ~/Documents/windows_share/"
alias ss="sudo mount -t cifs -o rw,uid=0,gid=0,dir_mode=0777,file_mode=0777,username="root",password="123" //192.168.3.66/samba_share ~/Documents/samba_share/"
